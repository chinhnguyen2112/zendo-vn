...
setcookie('luotquay_kc', ($_SESSION['user']['luotquay'] < 0) ? 0 : $_SESSION['user']['luotquay'], time() + 86400, '/');
setcookie('luotquay_acc_ff', ($_SESSION['user']['luotquay9k'] < 0) ? 0 : $_SESSION['user']['luotquay9k'], time() + 86400, '/');
