            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <span class="del_list"><a href="/them-loi/">Thêm lỗi</a> </span>
                        <div class="box_search_forrm">
                            <p>Bộ lọc</p>
                            <select name="" id="filter_types"  class="select2_this">
                                ...
                                <tbody>
                                    <?php foreach ($error as $key => $val) { ?>
                                        <tr>
                                            ...
                                            <td><?= $val['name'] ?></td>
                                            <td><?php
                                                $parent = $CI->Same->get_table(['id' => $val['parent']], 'error');
                                                echo $parent['name'];
                                                ?></td>
...
<script>
    function filter_ds() {
        ...
        var url = '/danh-sach-loi?keyword=' + keyword + '&type=' + type 
