...
<form id="form" class="form_change_pass">
    ...
    <input type="hidden" name="type_account" value="Pubg">
    ...
    <div class="form-group mb-3">
        ...
        <label for="have_pet" class="font-size17">Pet</label> <select class="form-control" name="pet">

            <option value="1" <?= (isset($list) && $list['pet'] == 1) ? 'selected' : '' ?>>Có</option>

            <option value="0" <?= (isset($list) && $list['pet'] == 0) ? 'selected' : '' ?>>Không</option>
    ...
    <div class="form-group mb-3">
        ...
        <label for="source" class="font-size17">Đăng ký</label> <select class="form-control" name="source" id="source">

            <option value="" disabled>Mời chọn</option>

            <option <?= (isset($list) && $list['source'] == 1) ? 'selected' : '' ?> value="1">Facebook</option>

            <option <?= (isset($list) && $list['source'] == 2) ? 'selected' : '' ?> value="2">Play game</option>

            <option <?= (isset($list) && $list['source'] == 3) ? 'selected' : '' ?> value="3">Play center</option>
    ...
    <div class="form-group mb-3">
        ...
        <label for="skin-trang-phuc" class="font-size17">Số skin trang phục <span style="color:#ff0000">*</span></label>

        <input class="form-control" type="number" id="skin-trang-phuc" name="skins_count" placeholder="Nhập skin trang phục" value="<?= isset($list['skins_count']) ? $list['skins_count'] : ""; ?>">

    </div>

    <div class="form-group mb-3">

        <label for="password" class="font-size17">Số skin súng <span style="color:#ff0000">*</span></label>

        <input class="form-control" type="number" id="skin-sung" name="champs_count" placeholder="Nhập Skin Súng" value="<?= isset($list['champs_count']) ? $list['champs_count'] : ""; ?>">

    </div>

    <div class="form-group mb-3">

        <label class="col-xs-12 font-size17" for="note">Nhập danh sách tên Trang phục <b data-toggle="tooltip" data-placement="right" title="Hiển thị ở trang chủ khi để chuột vào"><i class="fa fa-question-circle"></i></b></label>

        <div class="col-xs-12">

            <textarea class="form-control" id="ds-trang-phuc" name="skins" rows="4" placeholder="Enter để xuống dòng" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"><?= isset($list['note']) ? $list['skins'] : ""; ?></textarea>
    ...
    <div class="form-group mb-3">
        ...
        <label class="col-xs-12 font-size17" for="note">Nhập danh sách tên skin súng <b data-toggle="tooltip" data-placement="right" title="Hiển thị ở trang chủ khi để chuột vào"><i class="fa fa-question-circle"></i></b></label>

        <div class="col-xs-12">

            <textarea class="form-control" id="ds-skin-sung" name="champs" rows="4" placeholder="Enter để xuống dòng" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"><?= isset($list['note']) ? $list['champs'] : ""; ?></textarea>
    ...
    <div class="form-group mb-3">
        ...
        <select class="form-control" name="rank">
            ...
            <option <?= (isset($list) && $list['rank'] == 1) ? 'selected' : '' ?> value="1">Chưa xác định</option>
            ...
            <option <?= (isset($list) && $list['rank'] == 6) ? 'selected' : '' ?> value="6">Kim Cương</option>

            <option <?= (isset($list) && $list['rank'] == 7) ? 'selected' : '' ?> value="7">Cao thủ</option>

            <option <?= (isset($list) && $list['rank'] == 8) ? 'selected' : '' ?> value="8">Quán quân</option>

            <option <?= (isset($list) && $list['rank'] == 9) ? 'selected' : '' ?> value="9">Chí tôn</option>
