...
<form id="form" class="form_change_pass">
    ...
    <div class="group-form ">
        ...
        <div class="col-xs-12">
            ...
            <textarea class="form-control" id="gia-tri-dh" name="skins" rows="4" placeholder="Nhập danh sách tên vào đây, mỗi tên cách nhau bởi dấu phẩy để xuống dòng" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"><?= isset($list['skins']) ? $list['skins'] : ""; ?></textarea>
    ...
    <div class="group-form ">
        ...
        <div class="col-xs-12">
            ...
            <textarea class="form-control" id="bp-hien-co" name="champs" rows="4" placeholder="Nhập danh sách tên vào đây, mỗi tên cách nhau bởi dấu phẩy để xuống dòng" autocomplete="off" autocorrect="off" autocapitalize="off" spellcheck="false"><?= isset($list['champs']) ? $list['champs'] : ""; ?></textarea>
