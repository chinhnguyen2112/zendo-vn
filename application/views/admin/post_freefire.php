...
<form id="form" class="form_change_pass">
    ...
    <input type="hidden" name="type_account" value="Free Fire">
    ...
    <div class="form-group mb-3">
        ...
        <label for="source" class="font-size17">Đăng ký</label> <select class="form-control" name="source" id="source">
            ...
            <option value="0" <?= (isset($list) && $list['source'] == 0) ? 'selected' : '' ?>>Facebook</option>

            <option value="1" <?= (isset($list) && $list['source'] == 1) ? 'selected' : '' ?>>Vkontakate</option>
    ...
    <div class="form-group mb-3">
        ...
        <select class="form-control" name="rank">
            ...
            <option <?= (isset($list) && $list['rank'] == 7) ? 'selected' : '' ?> value="7">Huyền Thoại</option>

            <option <?= (isset($list) && $list['rank'] == 8) ? 'selected' : '' ?> value="8">Thách Đấu</option>
    ...
    <div class="form-group mb-">
        ...
        <label for="password" class="font-size17">Code 2fa</label>

        <input class="form-control" type="text" id="code_2fa" name="code_2fa" placeholder="Nhập Code 2fa" value="<?= isset($list['2fa']) ? $list['2fa'] : ""; ?>">
