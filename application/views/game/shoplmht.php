        ...
        <div class="body_list">
            <div class="box_fillter">
                ...
                <div class="box_price">
                    ...
                    <div class="content_search">
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="1" name="viet" id="viet" class="source_signup">
                            <span>Server Việt</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="2" name="han" id="han" class="source_signup">
                            <span>Server Hàn Quốc</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="3" name="na" id="na" class="source_signup">
                            <span>Server NA</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-source="4" name="pbe" id="pbe" class="source_signup">
                            <span>Server PBE</span>
                        </div>
                    </div>
                </div>
                <div class="box_price">
                ...
                <div class="box_price">
                    ...
                    <div class="content_search">
                        <div class="box_nav_price">
                            <input type="checkbox" data-rank="1" name="sat" class="rank_list">
                            <span>Sắt</span>
                        </div>
                        <div class="box_nav_price">
                        ...
                        <div class="box_nav_price">
                            <input type="checkbox" data-rank="8" name="daicaothu" class="rank_list">
                            <span>Đại cao thủ</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-rank="9" name="thachdau" class="rank_list">
                            <span>Thách đấu</span>
                        </div>
                    </div>
                </div>
