            ...
            <div class="box_fillter">
                ...
                <div class="box_price">
                    ...
                    <div class="content_search">
                        ...
                        <div class="box_nav_price">
                            <input type="checkbox" data-rank="6" name="dong" class="rank_list">
                            <span>Ngọc lục bảo</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-rank="7" name="kimcuong" class="rank_list">
                            <span>Kim cương</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-rank="8" name="caothu" class="rank_list">
                            <span>Cao thủ</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-rank="9" name="caothu" class="rank_list">
                            <span>Đại cao thủ</span>
                        </div>
                        <div class="box_nav_price">
                            <input type="checkbox" data-rank="10" name="thachdau" class="rank_list">
                            <span>Thách đấu</span>
                        </div>
                    </div>
                </div>
