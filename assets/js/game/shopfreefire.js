    ...
    $('.card_infinity').click(function() {
        if ($(this).prop('checked')) {
            $(".card_infinity").prop('checked', false);
            $(this).prop('checked', true);
            card_infinity = $(this).data('card');
        } else {
            card_infinity = "";
        }
        ms = 0;
