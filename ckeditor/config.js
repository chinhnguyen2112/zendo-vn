...
(function() {
                    ...
                    a : function( element ) {
                        if ( !element.attributes.rel ){
                           ...
                           //extract host names from URLs 
                            ...
                            if ( hostname !== window.location.host && hostname !=="zendo.vn") {
    ...
    CKEDITOR.editorConfig = function(config) {
        ...
        ***/
        ...
        // File browser
        config.filebrowserBrowseUrl = "https://sanacc.vn/ckeditor/ckfinder/ckfinder.php",
            config.filebrowserUploadUrl = "https://zendo.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files",
            config.filebrowserImageUploadUrl = "https://zendo.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images",
            config.filebrowserFlashUploadUrl = "https://zendo.vn/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash",
